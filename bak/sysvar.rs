...
use {
    ...
    solana_sysvar::stake_history::StakeHistory as SysvarStakeHistory,
...
pub struct Sysvars {
    ...
    pub stake_history: SysvarStakeHistory,
}
...
impl Default for Sysvars {
    fn default() -> Self {
        ...
        let stake_history = SysvarStakeHistory::default();
...
impl Sysvars {
    ...
    pub(crate) fn setup_sysvar_cache(&self, accounts: &[(Pubkey, Account)]) -> SysvarCache {
        ...
        sysvar_cache.fill_missing_entries(|pubkey, set_sysvar| {
            ...
            if pubkey.eq(&SysvarStakeHistory::id()) {
...
mod tests {
    ...
    fn test_to_sysvar_cache() {
        ...
        let stake_history = {
            let mut stake_history = SysvarStakeHistory::default();
